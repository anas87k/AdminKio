                ...
                <div class="col-6 col-sm-3 col-lg-4">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                            ...
                            <div style="font-size:4vw;" class="m-0">{{ $te }}</div>
                            <div class="text-green mb-4">Tenant</div>
                        </div>
                        <div class="small-box">
                            <a href="{{ url('/master/tenant') }}" style="background:#5eba00;" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                {{-- <div class="col-6 col-sm-4 col-lg-4">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                            ...
                            <i class="fa fa-codiepie" style="font-size:2em;"></i>
                            </div>
                            <div style="font-size:4vw;" class="m-0">{{ $fb }}</div>
                            <div class="text-orange mb-4">Food & Baverage</div>
                        </div>
                        <div class="small-box">
                        <a href="{{ url('/tenant') }}" style="background:#fd9644;" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div> --}}
                <div class="col-6 col-sm-4 col-lg-4">
                    <div class="card">
                        ...
                        <div class="small-box">
                            <a href="{{ url('/master/wisata') }}" style="background:#467fcf;" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-4">
                    <div class="card">
                        ...
                        <div class="small-box">
                            <a href="{{ url('/master/asisten') }}" style="background:#cd201f;" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                {{-- <div class="col-6 col-sm-4 col-lg-4">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                            <div class="text-right text-red">
                            <i class="fa fa-gg-circle" style="font-size:2em;"></i>
                            </div>
                            <div style="font-size:4vw;" class="m-0">{{ $sa2 }}</div>
                            <div class="text-red mb-4">Assistance</div>
                        </div>
                        <div class="small-box">
                ...
                <div class="col-6 col-sm-4 col-lg-4">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                            ...
                            <div style="font-size:4vw;" class="m-0">{{ $sa }}</div>
                            <div class="text-red mb-4">Other Assistance</div>
                        </div>
                        <div class="small-box">
                            <a href="{{ url('/asisten') }}" style="background:#cd201f;" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
