...
return [
    ...
    */
    'service_credentials' => [
        'username' => env('WATSON_TRANSLATE_USERNAME', 'khoirul.anas.id@gmail.com'),
        'password' => env('WATSON_TRANSLATE_PASSWORD', 'Tw1st123'),
    ],
    ...
    */
    'models' => [
        'default' => env('WATSON_TRANSLATE_DEFAULT_MODEL', 'id-en')
    ],
];
